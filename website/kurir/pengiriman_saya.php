...
$kurir = mysqli_fetch_assoc($qKurir);
$id_kurir = $kurir ? $kurir['id_kurir'] : 0;
...
if (isset($_POST['update_status'])) {
    ...
    $q = "UPDATE pengiriman_barang SET status_pengiriman='$status', tgl_kirim=IF($tgl_kirim IS NULL, tgl_kirim, $tgl_kirim), tgl_terima=IF($tgl_terima IS NULL, tgl_terima, $tgl_terima), update_oleh=$id_login WHERE id_pengiriman=$id_pengiriman AND id_kurir=$id_kurir";
...
$sql = "SELECT pb.*, b.kode_resi, b.nama_penerima, b.alamat_penerima
        FROM pengiriman_barang pb
        JOIN barang b ON pb.id_barang = b.id_barang
        WHERE pb.id_kurir = $id_kurir
...
<nav class="navbar navbar-expand-lg navbar-dark bg-warning">
  <div class="container-fluid">
    <a class="navbar-brand" href="dashboard.php">Kurir - Sistem Pengiriman</a>
    <div class="d-flex">
...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-2">
        <div>
            <h3 class="mb-1">Pengiriman Saya</h3>
            <?php if ($kurir): ?>
                <p class="text-muted small mb-0">Kurir: <strong><?php echo $kurir['nama_kurir']; ?></strong></p>
            <?php endif; ?>
        </div>
        <a href="dashboard.php" class="btn btn-outline-warning btn-sm">Kembali ke Dashboard</a>
    </div>
    <?php if ($success): ?>
